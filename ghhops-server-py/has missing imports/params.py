...
class HopsCircle(_GHParam):
    ...
    coercers = {
        ...
        lambda d: HopsCircle._make_circle(
            HopsPlane._make_plane(d["Plane"]["Origin"], d["Plane"]["XAxis"], d[
                "Plane"]["YAxis"]), d["Radius"])
    }
...
class HopsLine(_GHParam):
    ...
    coercers = {
        "Rhino.Geometry.Line":
        lambda l: RHINO_GEOM.Line(HopsLine._make_point(l["From"]),
                                  HopsLine._make_point(l["To"]))
    }
...
class HopsPlane(_GHParam):
    ...
    coercers = {
        ...
        lambda p: HopsPlane._make_plane(p["Origin"], p["XAxis"], p["YAxis"])
    }
...
class HopsPoint(_GHParam):
    ...
    coercers = {
        ...
        lambda d: RHINO_GEOM.Point2d(d["X"], d["Y"]),
        "Rhino.Geometry.Point3d":
        lambda d: RHINO_GEOM.Point3d(d["X"], d["Y"], d["Z"]),
        "Rhino.Geometry.Vector3d":
        lambda d: RHINO_GEOM.Vector3d(d["X"], d["Y"], d["Z"]),
    }
